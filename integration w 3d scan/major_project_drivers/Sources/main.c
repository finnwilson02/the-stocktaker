...
void delay_ms(int delay_length);
int m;
int n;
int i;

int* distance;
distance = (int*) malloc(100 * sizeof(int));
distance_counter = 0;
...
void main(void) {
  ...
  for(;;) {
    ...
    convertLaserUnits(&singleSample, &scaledSample, &servoPos);
    distance(distance_counter) = servoPos;
    distance_counter++;
    ...
    // Here is where we put the code for the magnet detection
