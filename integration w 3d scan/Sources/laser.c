...
void convertLaserUnits(unsigned long *sample, unsigned long *scaled_sample, long *servo_pan, long *servo_tilt){
  
  *scaled_sample = 0.0042*(*sample) - 15.685;
  *servo_pan = (2450 + iterator_counter)/30;
  *servo_tilt = tilt_up/30;
}
